...
const HeroSection = () => {
  return (
    <section
      id="home"
      className="min-h-screen pt-20 flex items-center bg-gradient-to-br from-pink-200 via-purple-300 to-red-300"
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            <span className="inline-block text-primary font-bold mb-2">
              Full Stack Web Developer
            </span>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Hi, I'm <span className="text-primary-200">Paramartha Ray</span>
            </h1>
